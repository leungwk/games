...
settings_custom_1 = {
    ...
    'taking.eruption': True, # otherwise the opening game seems slow, and it gives a more "math-y" feel. It is also equivalent to an archer.
    'taking.siege.block_marches': True,
    'taking.siege.surrounded': True,
    'taking.addition.marches': True,
    'taking.addition.line_adjacency': True, # enable just one
    'taking.addition.any_adjacency': False,
    'taking.multiplication.marches': True,
    'taking.multiplication.void_spaces': False, # eruption better
    'victory.take_pyramid_first': True, # forces the enemy to go after it
## <= 0, or an absent key, means disable
    # 'victory.bodies': 1, # [1,N]
    # 'victory.goods': False,
    # 'victory.goods.num': -1, # [1,N]
    # 'victory.quarrels': -1, # [1,N]
    # 'victory.honour': -1, # [1,N]
}
